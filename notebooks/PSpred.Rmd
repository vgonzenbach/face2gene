...
resROCPC2 = roc(group ~ PC2, data=cov_gafc_df)
plot(resROCPC2, main = sprintf("PC2 predictive of PS status (AUC = %s)", round(auc(resROCPC2),3)))
ci(resROCPC2)
```
...
resROCPC2 = roc(group ~ PC2, data=sz_gafc_df)
plot(resROCPC2, main = sprintf("PC2 predictive of SZ status (AUC = %s)", round(auc(resROCPC2),3)))
ci(resROCPC2)
```
...
resROCPC2 = roc(group ~ PC2, data=cr_gafc_df)
plot(resROCPC2, main = sprintf("PC2 predictive of CR status (AUC = %s)", round(auc(resROCPC2),3)))
ci(resROCPC2)
```
...
resROCPC2 = roc(group ~ PC2, data=cov_gafh_df)
plot(resROCPC2, main = sprintf("PC2 predictive of PS status (AUC = %s)", round(auc(resROCPC2),3)))
ci(resROCPC2)
```
...
resROCPC2 = roc(group ~ PC2, data=sz_gafh_df)
plot(resROCPC2, main = sprintf("PC2 predictive of SZ status (AUC = %s)", round(auc(resROCPC2),3)))
ci(resROCPC2)
```
...
resROCPC2 = roc(group ~ PC2, data=cr_gafh_df)
plot(resROCPC2, main = sprintf("PC2 predictive of CR status (AUC = %s)", round(auc(resROCPC2),3)))
ci(resROCPC2)
```
...
resROCPC2 = roc(group ~ PC2, data=cov_mmse_df)
plot(resROCPC2, main = sprintf("PC2 predictive of PS status (AUC = %s)", round(auc(resROCPC2),3)))
ci(resROCPC2)
```
...
resROCPC2 = roc(group ~ PC2, data=sz_mmse_df)
plot(resROCPC2, main = sprintf("PC2 predictive of SZ status (AUC = %s)", round(auc(resROCPC2),3)))
ci(resROCPC2)
```
...
resROCPC2 = roc(group ~ PC2, data=cr_mmse_df)
plot(resROCPC2, main = sprintf("PC2 predictive of CR status (AUC = %s)", round(auc(resROCPC2),3)))
ci(resROCPC2)
```
